...
@Suppress("FunctionName")
fun HorizontalPositionManager(context: Context, reverseLayout: Boolean = false): LinearLayoutPositionManager =
    LinearLayoutPositionManager(LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, reverseLayout))
