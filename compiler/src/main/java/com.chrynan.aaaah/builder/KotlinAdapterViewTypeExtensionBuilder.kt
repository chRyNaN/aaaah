...
class KotlinAdapterViewTypeExtensionBuilder : KotlinFileSpecBuilder {
    ...
    private val typeVariableName: TypeVariableName by lazy { TypeVariableName("T").withBounds(genericAnotherAdapterClassName) }
    private val anotherAdapterGenericJavaClassName: ParameterizedTypeName by lazy { javaClassName.parameterizedBy(typeVariableName) }
